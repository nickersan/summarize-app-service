...
public class SummaryController
{
  ...
  Summary update(@AuthenticationPrincipal Jwt jwt, @PathVariable("summaryId") long summaryId, @RequestBody SummaryRequest summaryRequest)
  {
    return summaryService.update(
      jwt.getSubject(),
      summaryId,
      summaryRequest.folderId,
      summaryRequest.name()
